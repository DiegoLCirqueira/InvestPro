...
/**
 * Página exclusiva do usuário (versão frontend/mock por enquanto).
 * Em breve (fullstack), esses dados virão da API/banco.
 */
export function UserProfile({ onClose }) {
  ...
  const Field = ({ label, value, disabledTone = false }) => (
